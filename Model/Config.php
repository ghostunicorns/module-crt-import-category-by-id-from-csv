...
namespace GhostUnicorns\CrtImportCategoryByIdFromCsv\Model;
...
{
    /** string */
    protected const CATEGORY_IMPORT_IS_ENABLED_CONFIG_PATH = 'crt_import/category_by_id_from_csv/enabled';

    /** string */
    protected const CATEGORY_IMPORT_CONTINUE_IN_CASE_OF_ERROR_CONFIG_PATH =
        'crt_import/category_by_id_from_csv/continue_in_case_of_errors';

    /** string */
    protected const CATEGORY_IMPORT_IS_LOG_ENABLED_CONFIG_PATH = 'crt_import/category_by_id_from_csv/log_enabled';

    /** string */
    protected const CATEGORY_IMPORT_LOG_LEVEL_CONFIG_PATH = 'crt_import/category_by_id_from_csv/log_level';
